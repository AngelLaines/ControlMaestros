...
namespace PDS___Final
{
    public partial class frmEditarTarea : Form
    {
        ...
        public frmEditarTarea(string id, string nombre)
        {
            this.id = id;
            this.nombre = nombre;
            InitializeComponent();
        ...
        private void btnAddH_Click(object sender, EventArgs e)
        {
            ...
            // Create Scalar query 
            string sql = @"update tareas set estado='" + cmbEstado.SelectedItem.ToString()+"' where nombre='" + txtTarea.Text + "' and numero_grupo=" + cmbGrupo.SelectedItem.ToString(); ;
