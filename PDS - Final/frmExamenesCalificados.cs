...
{
    public partial class frmExamenesCalificados : Form
    {
        private string id;
        private string nombre;
        Dictionary<string, string> dict = new Dictionary<string, string>();
        public frmExamenesCalificados(string id, string nombre)
        {
            this.id = id;
            this.nombre = nombre;
            InitializeComponent();
        ...
        private void frmExamenesCalificados_Load(object sender, EventArgs e)
        {
            // Create connection 
        ...
        private void actualizarGrid()
        {
            ...
            string sql = @"select al.nombres, al.apellido_paterno,al.apellido_materno, e.unidad as examen_unidad, ata.calificacion from alumnos_examenes ata join examenes e on e.id_examen=ata.id_examen join alumnos al on al.expediente=ata.expediente_alumno where ata.numero_grupo=" + cmbGrupo.SelectedItem.ToString() + " and ata.expediente_alumno=" + dict[cmbAlumno.SelectedItem.ToString()].ToString();
